...
<body>
        <div class="container-xl">
            ...
            <form action="order" method="POST">
                ...
                %>
                        <div class="cart-item">
                            <img src="Shirts/<%= item.getc_image() %>" class="cart-image" alt="<%= item.getc_name() %>">
                            <div class="cart-details">
                                <label class="cart-name">Product Name: <%=item.getCdesc()%></label>
                                <label class="cart-quantity">Quantity : <%=item.getQuantity() %></label>
                                <label class="cart-cost">Product Cost: &#8377; <%= item.getTotalCost() %></label>
                                <input type="hidden" name="pid" value="<%=item.getc_id()%>">
                                <input type="hidden" name="pdesc" value="<%=item.getCdesc()%>">
                                <input type="hidden" name="pimage" value="<%=item.getc_image()%>">
                                <input type="hidden" name="qty" value="<%=item.getQuantity()%>">
